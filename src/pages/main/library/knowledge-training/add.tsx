...
import { LibraryCategory, LibraryLabel, LibraryType } from 'data-design/src/entity/Library.entity';
...
export namespace LibraryCreateDTO {
  export interface LibraryCreateRequestData {
    title: string
    type: LibraryType
    label?: LibraryLabel
    price?: number
...
export default function(props: WithAdminPageProps) {
  ...
  const [data, setData] = useState<LibraryCreateDTO.LibraryCreateRequestData>({
    title: '',
    price: 12000,
    type: LibraryType.VIDEO,
    category: LibraryCategory['Skills Training'],
    length_minutes: 120,
    tags: [],
    is_micro_learning: false
  });
        ...
        <DetailContainer title={'Isi Detail Library'}>
          <XForm gap={'16px'} forms={[{
            ...
            async onChange(_file: any) {
              const file = await uploadFile(_file, setLoadingUploadFile);
              setData({
                ...data,
                file
              });
